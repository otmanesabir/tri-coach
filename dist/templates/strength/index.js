 ...
 */
export const strengthLower = {
    id: 'strength.lower',
    name: 'Lower Body Strength',
    sport: 'strength',
    category: 'strength',
    summary: 'Heavy compound lower body exercises. Improves running economy, cycling power, and injury resilience.',
    scientificRationale: 'Heavy resistance training (≤6 RM) improves neuromuscular recruitment and rate of force development without significant hypertrophy, directly improving running economy by 2-8% and cycling economy by 3-5%. The key adaptation is neural — better muscle fiber recruitment, not bigger muscles. Studies consistently show no negative interference with endurance performance when programmed correctly (Rønnestad & Mujika, 2014).',
    citations: [
...
export const strengthUpper = {
    id: 'strength.upper',
    name: 'Upper Body Strength',
    sport: 'strength',
    category: 'strength',
    summary: 'Upper body work for swim power, posture, and injury prevention. Essential for triathletes.',
    scientificRationale: 'Upper body strength directly improves swim propulsion and cycling stability. Triathletes often neglect upper body, leading to poor swim mechanics and cycling posture degradation in long events. Lat, shoulder, and core strength are primary swim force generators. Maintaining upper body during long bike/run prevents the "collapse" that costs time in the final hours (Aspenes & Karlsen, 2012).',
    citations: [
...
export const strengthRunner = {
    ...
    scientificRationale: 'Running injuries are primarily overuse injuries caused by inadequate tissue capacity. Strength training reduces running injury risk by 50-70% (Lauersen et al., 2014). Single-leg exercises address the asymmetries and lateral instability that cause IT band, knee, and hip issues. Calf and Achilles loading protocols are critical — the calf complex absorbs 6-8× body weight per stride.',
    citations: [
...
export const strengthTriathlon = {
...
export const strengthPlyometric = {
    ...
    scientificRationale: 'Plyometric training improves running economy by 2-8% by enhancing the stretch-shortening cycle (SSC) — the elastic energy stored in tendons during ground contact. Improved SSC efficiency means less metabolic energy needed per stride. A landmark study showed 9 weeks of explosive strength training improved 5K time by 3.1% without changes in VO2max (Paavolainen et al., 1999). For triathletes, this translates directly to running off the bike.',
    citations: [
