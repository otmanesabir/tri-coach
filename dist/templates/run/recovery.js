export const runRecovery = {
    ...
    scientificRationale: 'Active recovery at low intensity (< 65% VO2max) increases blood flow to damaged muscles, accelerating lactate clearance and nutrient delivery without adding meaningful training stress. The key is keeping intensity low enough that recovery is enhanced, not impaired. If a recovery run leaves you more fatigued, it\'s too hard (Menzies et al., 2010).',
    citations: [
