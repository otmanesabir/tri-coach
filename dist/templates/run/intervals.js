...
export const runIntervals1k = {
    id: 'run.intervals.1k',
    name: '1000m Intervals',
    sport: 'run',
    category: 'vo2max',
    summary: 'Longer VO2max intervals providing more time at peak oxygen uptake per repetition.',
    scientificRationale: 'Slightly longer than 800m, 1000m intervals at I-pace accumulate even more time at VO2max per rep. The 3-5 minute duration is considered the "sweet spot" for VO2max development, as it takes ~90-120 seconds to reach VO2max and then sustains it. Studies show 3-5min intervals are more effective than shorter intervals for VO2max gains (Bacon et al., 2013).',
    citations: [
