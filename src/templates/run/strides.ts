...
export const runStrides: WorkoutTemplate = {
  id: 'run.strides',
  name: 'Strides',
  sport: 'run',
  ...
  scientificRationale:
    'Strides (also called pick-ups or accelerations) maintain neuromuscular coordination and running economy without accumulating significant training stress. The short duration (15-25s) and full recovery (45-60s) mean no lactate accumulation — this is purely neuromuscular training. Strides improve running economy by reinforcing efficient motor patterns at high speed. They can be done year-round, even on easy days (Daniels, 2014).',
  citations: [
