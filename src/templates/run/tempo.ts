...
export const runTempo: WorkoutTemplate = {
  id: 'run.tempo',
  name: 'Tempo Run',
  sport: 'run',
  category: 'threshold',
  ...
  scientificRationale:
    'Tempo runs at 83-88% VO2max (Daniels T-pace) train the body to clear lactate more efficiently, raising the lactate threshold. This is the single most important intensity for endurance performance improvement in trained athletes. The threshold intensity represents the tipping point between sustainable and unsustainable effort — training here teaches the body to sustain a higher pace before lactate accumulates (Faude et al., 2009).',
  citations: [
